...
# instance fields
.field private zzdqp:Landroid/content/Context;
    .annotation build Landroid/support/annotation/GuardedBy;
        value = "this"
    .end annotation
.end field

.field private zzdqq:Ljava/lang/ref/WeakReference;
    .annotation build Landroid/support/annotation/GuardedBy;
        value = "this"
    .end annotation
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/internal/ads/zzasr;->zzdqq:Ljava/lang/ref/WeakReference;
...
.method private final declared-synchronized zzd(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    .line 18
    :try_start_0
    iget-object v0, p0, Lcom/google/android/gms/internal/ads/zzasr;->zzdqp:Landroid/content/Context;
    ...
    iget-object v1, p0, Lcom/google/android/gms/internal/ads/zzasr;->zzdqp:Landroid/content/Context;
...
.method private final declared-synchronized zze(Landroid/content/Intent;)V
    ...
    .line 25
    :try_start_0
    iget-object v0, p0, Lcom/google/android/gms/internal/ads/zzasr;->zzdqq:Ljava/lang/ref/WeakReference;
...
.method public static zzv(Landroid/content/Context;)Lcom/google/android/gms/internal/ads/zzasr;
    .locals 1

    .line 39
    new-instance v0, Lcom/google/android/gms/internal/ads/zzasr;

    invoke-static {p0}, Lcom/google/android/gms/internal/ads/zzasr;->zzk(Landroid/content/Context;)Landroid/content/Context;

    move-result-object p0

    invoke-direct {v0, p0}, Lcom/google/android/gms/internal/ads/zzasr;-><init>(Landroid/content/Context;)V
...
.method public static zzw(Landroid/content/Context;)Landroid/content/Context;
    ...
    .line 40
    instance-of v0, p0, Lcom/google/android/gms/internal/ads/zzasr;

    if-eqz v0, :cond_0

    .line 41
    check-cast p0, Lcom/google/android/gms/internal/ads/zzasr;

    invoke-virtual {p0}, Lcom/google/android/gms/internal/ads/zzasr;->getBaseContext()Landroid/content/Context;
...
.method public final declared-synchronized setAppPackageName(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/internal/ads/zzasr;->zzdqp:Landroid/content/Context;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized startActivity(Landroid/content/Intent;)V
    ...
    .line 16
    :try_start_0
    invoke-direct {p0, p1}, Lcom/google/android/gms/internal/ads/zzasr;->zzd(Landroid/content/Intent;)Landroid/content/Intent;

    move-result-object p1

    invoke-direct {p0, p1}, Lcom/google/android/gms/internal/ads/zzasr;->zze(Landroid/content/Intent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
