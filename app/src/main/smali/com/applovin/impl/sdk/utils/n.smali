...
# direct methods
.method private constructor <init>(Lcom/applovin/impl/sdk/i;Ljava/lang/Runnable;)V
    .locals 1
    ...
    iput-object p1, p0, Lcom/applovin/impl/sdk/utils/n;->a:Lcom/applovin/impl/sdk/i;
...
.method public static a(JLcom/applovin/impl/sdk/i;Ljava/lang/Runnable;)Lcom/applovin/impl/sdk/utils/n;
    .locals 3
    ...
    invoke-direct {v0, p2, p3}, Lcom/applovin/impl/sdk/utils/n;-><init>(Lcom/applovin/impl/sdk/i;Ljava/lang/Runnable;)V
    ...
    iget-object p3, v0, Lcom/applovin/impl/sdk/utils/n;->b:Ljava/util/Timer;
...
.method static synthetic a(Lcom/applovin/impl/sdk/utils/n;)Ljava/lang/Runnable;
    .locals 0
...
.method static synthetic a(Lcom/applovin/impl/sdk/utils/n;Ljava/util/Timer;)Ljava/util/Timer;
    .locals 0
...
.method static synthetic b(Lcom/applovin/impl/sdk/utils/n;)Lcom/applovin/impl/sdk/i;
    .locals 0

    iget-object p0, p0, Lcom/applovin/impl/sdk/utils/n;->a:Lcom/applovin/impl/sdk/i;

    return-object p0
.end method

.method static synthetic c(Lcom/applovin/impl/sdk/utils/n;)Ljava/lang/Object;
    .locals 0
...
.method public b()V
    ...
    :try_start_1
    iget-object v2, p0, Lcom/applovin/impl/sdk/utils/n;->b:Ljava/util/Timer;
    ...
    iget-wide v4, p0, Lcom/applovin/impl/sdk/utils/n;->c:J
    ...
    :try_start_3
    iget-object v3, p0, Lcom/applovin/impl/sdk/utils/n;->a:Lcom/applovin/impl/sdk/i;
...
.method public c()V
    ...
    :try_start_1
    iget-wide v1, p0, Lcom/applovin/impl/sdk/utils/n;->d:J

    iget-wide v5, p0, Lcom/applovin/impl/sdk/utils/n;->f:J

    const/4 v7, 0x0

    sub-long/2addr v1, v5

    iput-wide v1, p0, Lcom/applovin/impl/sdk/utils/n;->d:J
    ...
    :try_start_3
    iget-object v2, p0, Lcom/applovin/impl/sdk/utils/n;->a:Lcom/applovin/impl/sdk/i;
    ...
    invoke-virtual {v2, v5, v6, v1}, Lcom/applovin/impl/sdk/o;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
...
.method public d()V
    ...
    :try_start_1
    iget-object v4, p0, Lcom/applovin/impl/sdk/utils/n;->b:Ljava/util/Timer;
    ...
    :try_start_2
    iput-object v3, p0, Lcom/applovin/impl/sdk/utils/n;->b:Ljava/util/Timer;

    :goto_0
    iput-wide v1, p0, Lcom/applovin/impl/sdk/utils/n;->f:J
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1
    ...
    :try_start_3
    iget-object v5, p0, Lcom/applovin/impl/sdk/utils/n;->a:Lcom/applovin/impl/sdk/i;

    if-eqz v5, :cond_0

    iget-object v5, p0, Lcom/applovin/impl/sdk/utils/n;->a:Lcom/applovin/impl/sdk/i;

    invoke-virtual {v5}, Lcom/applovin/impl/sdk/i;->v()Lcom/applovin/impl/sdk/o;
    ...
    invoke-virtual {v5, v6, v7, v4}, Lcom/applovin/impl/sdk/o;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
