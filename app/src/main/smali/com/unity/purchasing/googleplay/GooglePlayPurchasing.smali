...
.method private addFreeTrialAndIntroPriceFlagToDeveloperPayload(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p2}, Lcom/unity/purchasing/googleplay/Inventory;->hasDetails(Ljava/lang/String;)Z
    ...
    const-string p1, "is_free_trial"

    .line 344
    invoke-virtual {v2, p1, v4}, Lorg/json/JSONObject;->put(Ljava/lang/String;Z)Lorg/json/JSONObject;

    const-string p1, "has_introductory_price_trial"

    .line 345
    invoke-virtual {v2, p1, v4}, Lorg/json/JSONObject;->put(Ljava/lang/String;Z)Lorg/json/JSONObject;

    const-string p1, "is_updated"

    .line 346
    invoke-virtual {v2, p1, v4}, Lorg/json/JSONObject;->put(Ljava/lang/String;Z)Lorg/json/JSONObject;

    const-string p1, "update_subscription_metadata"
    ...
    const-string v1, "oldSkuMetadata is NOT null"

    .line 360
    invoke-static {v1}, Lcom/unity/purchasing/googleplay/GooglePlayPurchasing;->log(Ljava/lang/String;)V

    .line 362
    invoke-direct {p0, p3, v0}, Lcom/unity/purchasing/googleplay/GooglePlayPurchasing;->getUpdateMetadata(Ljava/lang/String;Lcom/unity/purchasing/googleplay/SkuDetails;)Ljava/lang/String;
    ...
    :cond_3
    const-string p3, "oldSkuMetadata is null"

    .line 364
    invoke-static {p3}, Lcom/unity/purchasing/googleplay/GooglePlayPurchasing;->log(Ljava/lang/String;)V
    ...
    .line 371
    invoke-virtual {v0}, Lcom/unity/purchasing/googleplay/SkuDetails;->getIntroductoryPricePeriod()Ljava/lang/String;

    move-result-object v7

    .line 372
    invoke-virtual {v0}, Lcom/unity/purchasing/googleplay/SkuDetails;->getFreeTrialPeriod()Ljava/lang/String;

    move-result-object v0

    .line 373
    iget-object v8, p0, Lcom/unity/purchasing/googleplay/GooglePlayPurchasing;->inventory:Lcom/unity/purchasing/googleplay/Inventory;

    invoke-virtual {v8, p2}, Lcom/unity/purchasing/googleplay/Inventory;->hasPurchaseHistory(Ljava/lang/String;)Z
    ...
    invoke-virtual {v8, v9}, Lcom/unity/purchasing/googleplay/Inventory;->getAllSkus(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 379
    iget-object v10, p0, Lcom/unity/purchasing/googleplay/GooglePlayPurchasing;->inventory:Lcom/unity/purchasing/googleplay/Inventory;

    invoke-virtual {v10, v9}, Lcom/unity/purchasing/googleplay/Inventory;->getSkuDetails(Ljava/lang/String;)Lcom/unity/purchasing/googleplay/SkuDetails;

    move-result-object v10

    invoke-virtual {v10}, Lcom/unity/purchasing/googleplay/SkuDetails;->getFreeTrialPeriod()Ljava/lang/String;
    ...
    invoke-virtual {v10, v9}, Lcom/unity/purchasing/googleplay/Inventory;->hasPurchaseHistory(Ljava/lang/String;)Z
...
.method private getUpdateMetadata(Ljava/lang/String;Lcom/unity/purchasing/googleplay/SkuDetails;)Ljava/lang/String;
    ...
    :try_start_3
    const-string v2, "remaining_time_in_seconds"
    ...
    invoke-virtual {v2, p1}, Lcom/unity/purchasing/googleplay/Inventory;->hasDetails(Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, p1}, Lcom/unity/purchasing/googleplay/Inventory;->getSkuDetails(Ljava/lang/String;)Lcom/unity/purchasing/googleplay/SkuDetails;
    ...
    .line 463
    invoke-virtual {p2, v4, v9, v10}, Lorg/json/JSONObject;->put(Ljava/lang/String;J)Lorg/json/JSONObject;
...
.method public StartSubscriptionUpdate(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v1}, Lcom/unity/purchasing/googleplay/Inventory;->hasDetails(Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, v1}, Lcom/unity/purchasing/googleplay/Inventory;->hasPurchase(Ljava/lang/String;)Z
    ...
    .line 234
    invoke-direct {p0, v0, p3, p2}, Lcom/unity/purchasing/googleplay/GooglePlayPurchasing;->addFreeTrialAndIntroPriceFlagToDeveloperPayload(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
