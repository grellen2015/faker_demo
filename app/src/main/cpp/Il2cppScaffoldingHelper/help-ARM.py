...
def CustomInitializer():
	...
	idc.parse_decls(os.path.join(GetScriptDirectory(), "..\\Il2cpp-Scaffolding-ARM\\appdata\\il2cpp-types.h"), idc.PT_FILE)
...
with open(os.path.join(GetScriptDirectory(), ".\\help-ARM.json"), "r") as jsonFile:
